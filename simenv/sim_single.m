function [] = sim_single(sim_name, wind_scenario_path, wind_type, scenario_n, turbine_model_path, ...
    controller_name, observer_name)

    [simin, mdlcpy_path] = gen_simin(wind_scenario_path, wind_type, scenario_n, turbine_model_path,...
        controller_name, observer_name);
